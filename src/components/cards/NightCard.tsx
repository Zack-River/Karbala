        ...
        <div className="p-xl h-full flex flex-col relative z-10">
          ...
          <div className="mt-4 relative">
            <Link 
              ...
              className="before:absolute before:-inset-[1000px] before:z-0 outline-none"
              aria-disabled={night.isLocked}
            >
              <h3 className="font-scheherazade text-[1rem] text-karbala-gold-light line-clamp-2 leading-[1.4] mb-3 relative z-10">
                {night.title}
              </h3>
            </Link>
